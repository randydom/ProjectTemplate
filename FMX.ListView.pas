...
type
  ...
  strict private
    ...
    procedure SetItemBottomOffset(const Value: Integer); // ZuBy
  protected
    procedure ApplyStyle; override;
  ...
  public
    ...
    property TransparentSeparators: Boolean read FTransparentSeparator write FTransparentSeparator default False;
    // ZuBy
    property TransparentItems: Boolean read FTransparentItems write FTransparentItems default False; // ZuBy
  ...
  for I := StartItem to EndItem do
    ...
    begin
      ...
      begin
        ...
        if not FTransparentSeparator then // ZuBy
        begin
